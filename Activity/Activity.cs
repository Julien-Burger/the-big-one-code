...
public class Activity : MonoBehaviour
{
    ...
    public void EndActivity()
    {
        if (isEnemy)
        {
            ...
            {
                damage = references.GetFighter().GetDamage(true, false);
                isCriticalDamage = true;
            }
            else
            {
                damage = references.GetFighter().GetDamage(false, false);
    ...
    public bool GetEnemyCanBeSelected()
    {
        return enemyCanBeSelected;
    }

...
public class EndGame : MonoBehaviour
{
    ...
    {
        if (references.GetGameManager().GetCurrentSimulationDifficulty() == 1)
        {
        ...
        if (references.GetGameManager().GetCurrentSimulationDifficulty() == 10)
        {
        ...
        if (references.GetGameManager().GetCurrentSimulationDifficulty() == 20)
        {
        ...
        if (references.GetGameManager().GetCurrentSimulationDifficulty() == 29)
        {
            SteamUserStats.GetAchievement("ACH_WIN_GAME_29_DIFFICULTY", out bool achievementUnlock);

            if (!achievementUnlock)
            {
                SteamUserStats.SetAchievement("ACH_WIN_GAME_29_DIFFICULTY");

                references.GetAchievements().SetAchievement("ACH_WIN_GAME_29_DIFFICULTY");
            }
        }
    }

...
public class SimulationBoard : MonoBehaviour
{
    ...
    [SerializeField] GameObject noobModeDescriptionPanel;
    [SerializeField] GameObject[] noobModeDescriptionKeys;
    [SerializeField] Image noobModeDescritpionImg;
    [SerializeField] Sprite[] noobModeDescriptionSprites;
    ...
    private void Awake()
    {
        ...
        inputActions.UISimuBoard.LaunchGame.performed += ctx => OnLaunchGame();
        inputActions.UISimuBoard.CloseNoobModeDescription.performed += ctx => OnCloseNoobModeDescription();
    ...
    private void Start()
    {
        ...
        noobModeDescriptionPanel.SetActive(false);
    ...
    private void OnLaunchGame()
    {
        ...
        if (noobModeDescriptionPanel.activeInHierarchy) return;
    ...
    private void OnCloseNoobModeDescription()
    {
        if (!noobModeDescriptionPanel.activeInHierarchy) return;
    ...
    private void RefreshUI()
    {
        if (!keyboardEscapeImg.activeInHierarchy && references.GetGameManager().GetKeyboardControl())
        {
            ...
            noobModeDescriptionKeys[0].SetActive(true);
            noobModeDescriptionKeys[1].SetActive(false);
        }
        else if (!controllerEscapeImg.activeInHierarchy && !references.GetGameManager().GetKeyboardControl())
        {
            ...
            noobModeDescriptionKeys[0].SetActive(false);
            noobModeDescriptionKeys[1].SetActive(true);
        }
        ...
        if (references.GetGameManager().GetChangeUI() && !isSwitchKeySprite)
        {
            ...
            noobModeDescritpionImg.sprite = noobModeDescriptionSprites[1];
        }
        else if (!isSwitchKeySprite)
        {
            ...
            noobModeDescritpionImg.sprite = noobModeDescriptionSprites[0];
        }
    }
    ...
    private IEnumerator SwitchKeySprite(string index)
    {
        ...
        else if (index == "noob mode")
        {
            ...
            if (references.GetGameManager().GetNoobMode())
            {
                noobModeDescriptionPanel.SetActive(true);
            }
        }

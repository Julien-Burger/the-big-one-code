...
public class Sector : MonoBehaviour
{
    ...
    public void DecreaseRoomsRemaining(int numberOfRooms, bool increaseRoomCleared)
    {
        roomsRemaining -= numberOfRooms;

        if (increaseRoomCleared)
        {
    ...
    public void IncreaseRoomsRemaining(int numberOfRooms)
    {
        roomsRemaining += numberOfRooms;
    }

...
public class GameManager : MonoBehaviour, ISaveable
{
    ...
    int lastPrisonnersNumber = -1;
    const string lastPrisonnersNumberKey = "lastPrisonnersNumber";
    ...
    bool azertyControl = true;
    const string azertyControlKey = "azertyControl";

    bool haveChoseControl;
    const string haveChoseControlKey = "haveChoseControl";
    ...
    private void Start()
    {
        ...
        if (SceneManager.GetActiveScene().name == "Home")
        {
            ...
            StartCoroutine(intro.IntroDialogue(prisonnersNumber, lastPrisonnersNumber));

            if (lastPrisonnersNumber == -1)
            {
                lastPrisonnersNumber = 1;
            }
        }
    ...
    {
        lastPrisonnersNumber = prisonnersNumber;
    ...
    public IEnumerator ReturnHome(bool isDead, bool skipFader)
    {
    ...
    public float GetRoomClearMultiplier(bool health)
    {
        ...
        {
            return references.GetSector().GetRoomsCleared() / 50;
        }
    }
    ...
    public object CaptureState()
    {
        Dictionary<string, object> data = new()
        {
            ...
            { lastPrisonnersNumberKey, lastPrisonnersNumber },
            ...
            { haveChoseControlKey, haveChoseControl },
    ...
    public void RestoreState(object state)
    {
        ...
        foreach (KeyValuePair<string, object> item in data)
        {
            ...
            else if (item.Key == lastPrisonnersNumberKey)
            {
                lastPrisonnersNumber = (int)item.Value;
            }
            ...
            else if (item.Key == haveChoseControlKey)
            {
                haveChoseControl = (bool)item.Value;
            }

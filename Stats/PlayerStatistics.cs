...
public class PlayerStatistics : MonoBehaviour, ISaveable
{
    ...
    float healthBonusForLimitedTimeNormal;
    float healthBonusDividerNormal;

    float damageBonusForLimitedTime;
    float damageBonusDivider;
    float damageBonusForLimitedTimeNormal;
    float damageBonusDividerNormal;
    ...
    private void Update()
    {
        ...
        DamageBonusForLimitedTimeNormal();
    ...
    public float GetBaseHealth()
    {
        ...
        health = baseHealth + healthBonus + healthPNJBonus + healthBonusForLimitedTime + healthBonusForLimitedTimeNormal + hotFatty;
    ...
    public float GetBaseDamage()
    {
        ...
        float damage = baseDamage + damagePNJBonus + statBoardDamageBonus + damageBonusForLimitedTime + damageBonusForLimitedTimeNormal + hotSpicy;
    ...
    public void AddHealthForLimitedTimeNormal(float amount)
    {
        healthBonusForLimitedTimeNormal += amount;

        healthBonusDividerNormal = healthBonusForLimitedTimeNormal / 60f;

        if (healthBonusForLimitedTimeNormal < 0f)
        {
            healthBonusForLimitedTimeNormal = 0f;
            healthBonusDividerNormal = 0f;
        }
    }
    ...
    public float GetHealthBonusDividerNormal()
    {
        return healthBonusDividerNormal;
    }
    ...
    public void AddDamageForLimitedTimeNormal(float amount)
    {
        damageBonusForLimitedTimeNormal += amount;

        damageBonusDividerNormal = damageBonusForLimitedTimeNormal / 60f;

        if (damageBonusForLimitedTimeNormal < 0f)
        {
            damageBonusForLimitedTimeNormal = 0f;
            damageBonusDividerNormal = 0f;
        }
    }
    ...
    private void DamageBonusForLimitedTimeNormal()
    {
        if (damageBonusDividerNormal == 0) return;
        if (references.GetRoomPool().GetCurrentRoom().GetCanExitRoom()) return;

        float damage = damageBonusDividerNormal * Time.deltaTime * -1;

        AddDamageForLimitedTimeNormal(damage);

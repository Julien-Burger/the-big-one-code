...
public class NPC : MonoBehaviour
{
    ...
    private void SetupPropositions()
    {
        ...
        for (int i = 0; i < proposition.Length; i++)
        {
            ...
            FinishSetupProposition(i, propositionSettingsIndex);
        }
    }

    private void SetupMerchantPropositions()
    {
        int lastPropositionSettingsIndex = -1;

        for (int i = 0; i < proposition.Length; i++)
        {
            int propositionSettingsIndex;
            ...
            while (true)
            {
                ...
                if (propositionSettings[propositionSettingsIndex].passiveIndex != PassiveIndex.None &&
                    references.GetPassiveObject().GetPassiveObject(propositionSettings[propositionSettingsIndex].passiveIndex)) continue;

                else if (propositionSettings[propositionSettingsIndex].trinketIndex != TrinketIndex.None &&
                    references.GetTrinket().GetCurrentTrinket() == propositionSettings[propositionSettingsIndex].trinketIndex) continue;
    ...
    private void FinishSetupProposition(int i, int propositionSettingsIndex)
    {
